...
(function(){
  ...
  DrawMixin = {
    ...
    render: function(){
      var data, attrs, ref$, style, props, key, attr, childPropsList, res$, i$, ref1$, children;
      ...
      res$ = [];
      for (i$ in ref1$ = data.children) {
        res$.push((fn$.call(this, i$, ref1$[i$])));
      }
      childPropsList = res$;
      children = filter(
